...
importMiniui(function () {
    ...
    $("#setting_sign_psw").on('click',function () {
        mini.getbyName("personUser.password").setReadOnly(false);
    ...
    function addPosToGrid() {
        require(["message"], function (message) {
            ...
            var row = {org: area.getSelectedNode(), department: department.getSelectedNode(), position: pos, positionId: pos.id};
