package org.bestfeng.template.user.config;
 ...
 */
@Component
@ConfigurationProperties("template-token")
public class TemplateUserTokenGenerator implements UserTokenGenerator, UserTokenParser {
