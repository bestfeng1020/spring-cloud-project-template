package org.bestfeng.template.user.web;
...
public class UserLockController {
    ...
    @ApiOperation(value = "修改解锁密码", hidden = true)
    ...
    @PutMapping("/lock")
    @ApiOperation(value = "锁定登录", hidden = true)
    ...
    @ApiOperation(value = "退出登录", hidden = true)
    ...
    @PutMapping("/un-lock")
    @Authorize(ignore = true)
    @ApiOperation(value = "解锁登录", hidden = true)
